...
const CONFIG = {
  ...
  empresa: {
    ...
    logoTexto: "Boteko", // usado enquanto não houver logo em imagem
    // logoImagem: "assets/images/logo.svg", // descomente e aponte para o arquivo se tiver um logo em imagem
    favicon: "assets/icons/favicon.svg",
    dominio: "https://www.botekos.com.br" // usado nas tags de SEO / Open Graph
  },
  ...
  // --------------------------------------------------------------------------
  // HORÁRIO DE FUNCIONAMENTO (exibido no rodapé / seção de contato)
  // --------------------------------------------------------------------------
  horario: {
    linhas: [
